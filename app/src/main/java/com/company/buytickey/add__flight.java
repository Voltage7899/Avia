...
public class add__flight extends AppCompatActivity {

    //Переменые для записи данных из полей и путь для картинки(URI)
    private String id, price, departure,landing,from,to, image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_db.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                price = name_field.getText().toString();
                ...
                if (imageUri == null) {
                    Toast.makeText(add__flight.this, "Добавьте картинку", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(price)) {
                    Toast.makeText(add__flight.this, "Добавьте название", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(departure)) {
                    Toast.makeText(add__flight.this, "Добавьте отправление", Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(landing)) {
                    Toast.makeText(add__flight.this, "Добавьте приземление", Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(from)) {
                    Toast.makeText(add__flight.this, "Добавьте откуда", Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(to)) {
                    Toast.makeText(add__flight.this, "Добавьте куда", Toast.LENGTH_SHORT).show();
                }else {
        ...
        database.child(id).updateChildren(SweatMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(add__flight.this, "Произошла ошибка", Toast.LENGTH_SHORT).show();
                }
            }
        });
